...
if (palette==1)                  // Palette 1 - Original. //
{
    ...
    shader_set_uniform_f(shader_get_uniform(shGameBoy,"u_color2"), 78, 145, 100);     //  Setting color 2
...
draw_surface_stretched(application_surface,0,0,window_get_width()/2,window_get_height()/2);  //redrawing the application surface to the GUI redraws the screen with the shader enabled.
