...
///左右移动
if ! (state = RUN) if kLeft and kRight {
        kLeft = false;
        kRight = false;
} //处理左右按下时候漂移的问题
if (state != ROLL) {
        ...
        if (kLeft && !kRight && !sticking) {
                ...
                if (vx > 0) vx = Approach(vx, 0, tempFric);
...
if (!attacking) {
        ...
        case IDLE:
                ...
                if (blocking) sprite_index = sIdle;
        ...
        case RUN:
                ...
                if (blocking) sprite_index = sRun;
                else sprite_index = sRun;
                break;
